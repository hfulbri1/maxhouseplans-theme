...
function plan_content() { ?> 
              ...
              <div class="tab-pane" id="profile">
                ...
                <p>Each set of plans includes:
                    ...
                    <div class="one-third first border">
                        <img class="alignnone size-full wp-image-1466" style="margin-bottom: 30px;" title="House Plan Front Elevation" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/House-Plan-Front-Elevation.png" alt="House Plan Front Elevation" width="295" height="191">
                    </div>
                    <div class="one-third border">
                        <img class="alignnone size-full wp-image-1467" style="margin-bottom: 30px;" title="House Plan Left Elevation" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/House-Plan-Left-Elevation.png" alt="House Plan Left Elevation" width="295" height="205">
                    </div>
                    <div class="one-third">
                        <img class="alignnone size-full wp-image-1468" style="margin-bottom: 30px;" title="House Plan Rear Elevation" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/House-Plan-Rear-Elevation.png" alt="" width="295" height="186">
                    </div>
                </div>
                <div class="elevations borderlow">
                    <h3>Floor Plans</h3>
                    ...
                    <div class="one-half first">
                        <img class="alignnone size-full wp-image-1471" title="Main Level Floor Plan" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/Main-Level-Floor-Plan.png" alt="Main Level Floor Plan" width="400" height="356">
                    </div>
                    <div class="one-half">
                    <img class="size-full wp-image-1492 alignnone" title="Upper Level Floorplan" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/Upper-Level-Floorplan.png" alt="Upper Level Floorplan" width="400" height="374">
                    </div>
                </div>
                <div class="elevations">
                    <div class="one-half first border">
                    <h3>Foundation Plan</h3>
                        <img class="alignnone size-full wp-image-1470" style="margin-bottom: 31px;" title="Lower Level Floor Plan" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/Lower-Level-Floor-Plan.png" alt="Lower Level Floor Plan" width="400" height="330">
                    </div>
                    <div class="one-half">
                    <h3>Roof Plan</h3>
                        <img class="size-full wp-image-1469 alignnone" title="House Roof Plan" src="<?php echo home_url(); ?>/wp-content/uploads/2011/08/House-Roof-Plan.png" alt="House Roof Plan" width="450" height="494">
                    </div>
                </div>
                    <p>Notes:
    ...
    <div class="paypal">
        <div class="one-half first paypal">
            <p><?php echo get_field("paypal", false, false); ?></p>
        </div>
        <div class="one-half">
...
<?php next_post_link( '%link', 'Next Plan', TRUE, '31,26,9' ); ?>
</div>
<div class="arrowLeft">
<?php previous_post_link( '%link', 'Prev Plan', TRUE, '31,26,9' ); ?>
</div>
</div>
<div class="moreplanscont">
    <div class="wrap">
        <div class="relatedplans">	
            ...
            $backup = $post;
							  $categories = get_the_terms( $post->ID, 'home-plans_categories' );     
