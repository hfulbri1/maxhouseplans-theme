...
$args = array(
    'post_type'=>'plans', // Your post type name
    'posts_per_page' => 20,
    'paged' => $paged,
    'post_status' => 'publish',
    'orderby' => 'date',
 ...
 $result11 = new WP_Query( $args );
if ( $result11-> have_posts() ) { ?>
<?php while ( $result11->have_posts() ) : $result11->the_post();
...
<?php 
                 ...
                 $total_pages = $result11->max_num_pages;
...
function child_sidebar_max() { ?> 
    ...
    <div class="plansinfo">
        <h2 class="planheader">Floor Plans Search:</h2>
